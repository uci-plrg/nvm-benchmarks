...
//1u Class Definition----------------
template<> class MultiMaskPartialKeyMapping<1u>  : public PartialKeyMappingBase {

public:
	static constexpr unsigned int MINIMUM_EXTRACTION_BIT_COUNT_SUPPORTED = 1u * 8;
	static constexpr unsigned int NUMBER_BITS = 1u * 64;
	using SIMDHelperType = SIMDHelper<NUMBER_BITS>;
	using SIMDRegisterType = typename SIMDHelperType::SIMDRegisterType;
	using ExtractionDataArray = std::array<uint64_t, 1u>;
...
public:
	inline SIMDRegisterType getPositionsRegister() const; 
	inline SIMDRegisterType getExtractionDataRegister() const; 
	inline MultiMaskPartialKeyMapping(MultiMaskPartialKeyMapping<1u> const & src);
	 ...
	 * @param src a compatible partial key mapping
	 */
	inline MultiMaskPartialKeyMapping(typename std::conditional<1u == 1, SingleMaskPartialKeyMapping, MultiMaskPartialKeyMapping<1u/2>>::type const &src);
	 ...
	 * @param discriminatingBit the new discriminating bit to add
	 */
	inline MultiMaskPartialKeyMapping(MultiMaskPartialKeyMapping<1u> const & existing, DiscriminativeBit const & significantKeyInformation, unsigned int extractionByteIndex);
...
//2u Class Definition---------------------------------------
template<> class MultiMaskPartialKeyMapping<2u>  : public PartialKeyMappingBase {

public:
	static constexpr unsigned int MINIMUM_EXTRACTION_BIT_COUNT_SUPPORTED = 2u * 8;
	static constexpr unsigned int NUMBER_BITS = 2u * 64;
	using SIMDHelperType = SIMDHelper<NUMBER_BITS>;
	using SIMDRegisterType = typename SIMDHelperType::SIMDRegisterType;
	using ExtractionDataArray = std::array<uint64_t, 2u>;
...
public:
	inline SIMDRegisterType getPositionsRegister() const;
	inline SIMDRegisterType getExtractionDataRegister() const;
	inline MultiMaskPartialKeyMapping(MultiMaskPartialKeyMapping<2u> const & src);
	 ...
	 * @param src a compatible partial key mapping
	 */
	inline MultiMaskPartialKeyMapping(typename std::conditional<2u == 1, SingleMaskPartialKeyMapping, MultiMaskPartialKeyMapping<2u/2>>::type const &src);
	 ...
	 * @param discriminatingBit the new discriminating bit to add
	 */
	inline MultiMaskPartialKeyMapping(MultiMaskPartialKeyMapping<2u> const & existing, DiscriminativeBit const & significantKeyInformation, unsigned int extractionByteIndex);
...
//4u Class Definition------------------------------------------
template<> class MultiMaskPartialKeyMapping<4u>  : public PartialKeyMappingBase {

public:
	static constexpr unsigned int MINIMUM_EXTRACTION_BIT_COUNT_SUPPORTED = 4u * 8;
	static constexpr unsigned int NUMBER_BITS = 4u * 64;
	using SIMDHelperType = SIMDHelper<NUMBER_BITS>;
	using SIMDRegisterType = typename SIMDHelperType::SIMDRegisterType;
	using ExtractionDataArray = std::array<uint64_t, 4u>;
...
public:
	inline SIMDRegisterType getPositionsRegister() const;
	inline SIMDRegisterType getExtractionDataRegister() const;
	inline MultiMaskPartialKeyMapping(MultiMaskPartialKeyMapping<4u> const & src);
	 ...
	 * @param src a compatible partial key mapping
	 */
	inline MultiMaskPartialKeyMapping(typename std::conditional<4u == 1, SingleMaskPartialKeyMapping, MultiMaskPartialKeyMapping<4u/2>>::type const &src);
	 ...
	 * @param discriminatingBit the new discriminating bit to add
	 */
	inline MultiMaskPartialKeyMapping(MultiMaskPartialKeyMapping<4u> const & existing, DiscriminativeBit const & significantKeyInformation, unsigned int extractionByteIndex);
...
public:
	...
	template<typename Operation> auto executeWithCorrectMaskAndDiscriminativeBitsRepresentation(Operation const & operation) const;
	/**
	 * compresses this partial key mapping to the most space efficient partial key mapping which is able to represent the discriminative bits represented by this partial key mapping
	 *
	 * @tparam Operation the callback type
