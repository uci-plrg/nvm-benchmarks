...
column_or_super_column_instance_init (ColumnOrSuperColumn * object)
{
	...
	object->super_column = g_object_new (TYPE_SUPER_COLUMN, NULL);
	object->__isset_super_column = FALSE;
	object->counter_column = g_object_new (TYPE_COUNTER_COLUMN, NULL);
	object->__isset_counter_column = FALSE;
	object->counter_super_column = g_object_new (TYPE_COUNTER_SUPER_COLUMN, NULL);
...
slice_predicate_instance_init (SlicePredicate * object)
{
	...
	object->slice_range = g_object_new (TYPE_SLICE_RANGE, NULL);
...
deletion_instance_init (Deletion * object)
{
	...
	object->super_column = NULL;
	object->__isset_super_column = FALSE;
	object->predicate = g_object_new (TYPE_SLICE_PREDICATE, NULL);
...
mutation_instance_init (Mutation * object)
{
	/* satisfy -Wall */
	THRIFT_UNUSED_VAR (object);
	object->column_or_supercolumn = g_object_new (TYPE_COLUMN_OR_SUPER_COLUMN, NULL);
	object->__isset_column_or_supercolumn = FALSE;
	object->deletion = g_object_new (TYPE_DELETION, NULL);
...
cql_result_instance_init (CqlResult * object)
{
	...
	object->schema = g_object_new (TYPE_CQL_METADATA, NULL);
